...
namespace TriviaRoyaleGame.Api.Controllers
{
    ...
    public class MemberController(
        IGenericService<Member> genericService,
        IMapper mapper, ILogger<GenericController<Member, MemberViewModel>> logger,
        IHostEnvironment hostEnvironment,
        IConfiguration configuration,
        IHubContext<RealTimeHub> hubContext,
        IMemoryCache cache,
        ISendMailService sendMailService) : GenericController<Member, MemberViewModel>(genericService, mapper, logger, hostEnvironment, configuration, hubContext, cache, sendMailService)
    { }
}