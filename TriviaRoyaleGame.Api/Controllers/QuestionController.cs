...
namespace TriviaRoyaleGame.Api.Controllers
{
    ...
    public class QuestionController(
        IGenericService<Question> genericService,
        IMapper mapper, ILogger<GenericController<Question, QuestionViewModel>> logger,
        IHostEnvironment hostEnvironment,
        IConfiguration configuration,
        IHubContext<RealTimeHub> hubContext,
        IMemoryCache cache,
        ISendMailService sendMailService) : GenericController<Question, QuestionViewModel>(genericService, mapper, logger, hostEnvironment, configuration, hubContext, cache, sendMailService)
    { }
}